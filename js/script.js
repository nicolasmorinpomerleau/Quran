...
(function() {
    ...
    if (feedbackBtn) feedbackBtn.addEventListener('click', function() {
        closeMobileDrawer();
        window.open('mailto:?subject=Quran%20App%20Feedback&body=Version%3A%20v10.14.12%0A%0A', '_blank');
